...
class Locators:
    ...
    REG_NAME = (By.XPATH, "//form[@class='Auth_form__3qKeq mb-20']/fieldset[1]/div/div/input")
    REG_EMAIL = (By.XPATH, "//form[@class='Auth_form__3qKeq mb-20']/fieldset[2]/div/div/input")
    REG_PASSWORD = (By.XPATH, "//form[@class='Auth_form__3qKeq mb-20']/fieldset[3]/div/div/input")
    ...
    EDIT_NAME = (By.XPATH, "//ul[@class='Profile_profileList__3vTor']/li[1]/div/div/input")
    EDIT_EMAIL = (By.XPATH, "//ul[@class='Profile_profileList__3vTor']/li[2]/div/div/input")
    EDIT_PASSWORD = (By.XPATH, "//ul[@class='Profile_profileList__3vTor']/li[3]/div/div/input")
    #Ссылка "Войти" на странице регистрации
    ...
    LOGO_ON_PERSONAL_ACCOUNT = (By.XPATH, "//div[@class='AppHeader_header__logo__2D0X2']/a[@href='/']")
    ...
    #Ссылка "Булки"
    DIV_BREADS = (By.XPATH, "//div[@style='display: flex;']/div[1]")
    #Ссылка "Соусы"
    DIV_SAUCES = (By.XPATH, "//div[@style='display: flex;']/div[2]")
    #Ссылка "Начинки"
    DIV_TOPPINGS = (By.XPATH, "//div[@style='display: flex;']/div[3]")
